      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex flex-col gap-2">
          ...
          <WhatsAppButton
            href={waLink}
            vehicleName={title}
            className="flex items-center justify-center gap-2 w-full bg-green-wa text-[var(--cream-bg)] text-sm font-semibold py-2 rounded-[var(--radius-sm)] hover:brightness-110 transition-all"
          >
