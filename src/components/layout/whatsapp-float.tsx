...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Pulse dot */}
      <span className="absolute top-0 right-0 w-3.5 h-3.5 bg-green-wa rounded-full animate-ping opacity-75" />
      <span className="absolute top-0 right-0 w-3.5 h-3.5 bg-green-wa rounded-full border-2 border-white" />
    </a>
  );
}
